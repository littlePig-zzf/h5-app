  ...
  <div class="container user-module">
    <div class="head-item">
      <dl class="head-img">
        ...
        <dt>
          <p class="username">{{user.name}}<img v-if="user.vip_expire_at" class="vip-icon" src="/images/user_vip.png" alt=""></p>
          <p class="coin-num"><img src="/images/user_meney.png" alt=""> {{user.money}} 阅币</p>
        </dt>
      </dl>
    ...
    <ul class="user-operate">
      <li @click="goToMenu(item)" v-for="(item, index) in menuList" :key="index">
        <img :src="`/images/user_${item.icon}.png`" alt="">
