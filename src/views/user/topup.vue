      ...
      <form ref="Form" action="/order" method="POST">
        ...
        <ul class="item">
          <li v-for="(item, index) in topup" :key="index" :class="{'active': selectedIndex === index}" @click="selectedIndex = index">
            <img v-show="item.type === 1" class="icon" src="/images/recommend.png" alt="">
            <img v-show="item.type === 3" class="icon vip" src="/images/vip.png" alt="">
...
<style lang="less">
@import "../../assets/css/user/topup.less";
</style>
