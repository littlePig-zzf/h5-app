...
export const BASE_URL = "https://test-manhua.alaskamob.com/1";
...
export const api = {
  ...
  topup: chapterId =>
    apiClicent.get("topup", { params: { chapter_id: chapterId } }),
  ...
  comic: {
    ...
    comicBookmark: page =>
      apiClicent.get("comic/bookmark", { params: { page } }),
    batchDestoryBookmark: ids =>
      apiClicent.delete(`comic/bookmark`, { params: { comic_ids: ids } }),
    batchDestoryHistory: ids =>
      apiClicent.delete(`comic/history`, { params: { comic_ids: ids } })
  },
  chapter: {
    show: id => apiClicent.get(`chapter/${id}`),
    buy: (id, autoBuyChapter) =>
      apiClicent.post(`chapter/${id}/buy`, { auto_buy_chapter: autoBuyChapter })
  },
  user: {
    ...
    transaction: {
      expend: page =>
        apiClicent.get("user/transaction/expend", { params: { page } }),
      income: page =>
        apiClicent.get("user/transaction/income", { params: { page } })
    }
  },
  search: {
